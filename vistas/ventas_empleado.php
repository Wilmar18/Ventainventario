                            ...
                            <div class="card-body">
                                ...
                                <form>
                                    ...
                                    <div class="bordde">
                                        <div id="tablaaa"></div>
                                        <div class="col-lg-12">
                                            <h4 style="text-align:right">TOTAL S/.
    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <!-- end row -->
                <form action="ventas_empleado.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <label for="txtinfo"><?php echo ""  ?></label>
                        </div>
                        <div class="col-lg-1"></div>
                    </div>
                    <hr>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        if (isset($_POST['txtnombre'])) {
                            ...
                            $obj = new VentaEmpleado();
                            $result = $obj->consultar_venta($_POST['txtnombre']);
                            if ($result == true) {
                        ...
                        ?>
                                ...
                                <?php
                                        ...
                                        $errorMsg = "Ningun dato que mostrar";
                                        die($errorMsg);
                                    }
                                } else {
                                } ?>
