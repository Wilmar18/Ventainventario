      ...
      <div class="modal-body">
       <form id="frmproducto">
        <div class="row" >
            ...
            <input type="number" class="form-control" id="txtstockminimo" name="txtstockminimo">

            <label>Despacho</label>
            <select name="txtdespacho" id="txtdespacho" class="form-control select">
...
<div class="modal-body">
       <form id="frmproductoe">
        <div class="row">
            ...
            <label>Stock Minimo (*)</label>
            <input type="number" class="form-control" id="txtstockminimoe" name="txtstockminimoe">
            <label>Despacho</label>
            <select name="txtdespachoe" id="txtdespachoe" class="form-control select">
                <option value="A">Seleccione</option>
                <option value="Unidad">Unidad</option>
                <option value="Paquete">Paquete</option>
                <option value="Kg">Kg</option>
                        ...
                        $('#btneditar').unbind().click(function(){
                            ...
                            stokmin = $("#txtstockminimoe").val();
                             oka = {
                                        ...
                                        "txtstocke" : sto, "txtdespachoe": des,
                                        "txtproveedore" : prove,
                                        "txtcategoriae" : cate,
